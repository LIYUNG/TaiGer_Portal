...
from database.ChemicalEngineering.CME_Programs import program_sort_function, column_len_array
...
def CME_sorter(program_idx, file_path, abbrev, studentId, student_name, analysis_language):
    basic_classification_en = {
        ...
        '經濟': [ECONOMICS_KEY_WORDS_EN, ECONOMICS_ANTI_KEY_WORDS_EN, ['一', '二']],
        ...
        '會計': [ACCOUNTING_KEY_WORDS_EN, ACCOUNTING_ANTI_KEY_WORDS_EN, ['一', '二']],
        '統計': [STATISTICS_KEY_WORDS_EN, STATISTICS_ANTI_KEY_WORDS_EN, ['一', '二']],
    ...
    basic_classification_zh = {
        ...
        '會計': [ACCOUNTING_KEY_WORDS, ACCOUNTING_ANTI_KEY_WORDS, ['一', '二']],
