...
CS_COMP_NETW_ANTI_KEY_WORDS = ['asdgladfj', '工業', '食品', '應用', '程式', '神經', '國家', '台灣', '國際', '南海']
...
CS_MATH_GRAPH_THEORY_KEY_WORDS = ['圖論', '圖形', '圖型']
CS_MATH_GRAPH_THEORY_ANTI_KEY_WORDS = ['asdgladfj;l', '設計']
...
CS_MATH_GENERAL_KEY_WORDS = ['數學']
CS_MATH_GENERAL_ANTI_KEY_WORDS = ['asdgladfj;l', '管理', '文明', '服務']
...
CS_PROGRAMMING_ANTI_KEY_WORDS_EN = ['web', '視窗', 'business',
...
CS_MATH_LOGIC_KEY_WORDS_EN = ['logic']
CS_MATH_LOGIC_PROG_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
CS_MATH_GRAPH_THEORY_KEY_WORDS_EN = ['graph theor']
CS_MATH_GRAPH_THEORY_ANTI_KEY_WORDS_EN = ['asdgladfj;l', '設計']
...
CS_MATH_GENERAL_KEY_WORDS_EN = ['math']
CS_MATH_GENERAL_ANTI_KEY_WORDS_EN = ['asdgladfj;l', '管理', '文明', '服務']
CS_MATH_DISCRETE_KEY_WORDS_EN = ['discrete math', 'graph', '邏輯']
CS_MATH_DISCRETE_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
CS_MATH_LIN_ALGE_KEY_WORDS_EN = ['linear algebra', 'numerical']
CS_MATH_LIN_ALGE_ANTI_KEY_WORDS_EN = ['asdgladfj;l']
CS_MATH_NUM_METHOD_KEY_WORDS_EN = ['numerical']
