...
def EE_sorter(program_idx, obj_arr, abbrev, studentId, student_name, analysis_language):
    ...
    basic_classification_en = {
        ...
        '電路設計': [EE_ELECTRO_CIRCUIT_DESIGN_KEY_WORDS_EN, EE_ELECTRO_CIRCUIT_DESIGN_ANTI_KEY_WORDS_EN],
    ...
    basic_classification_zh = {
        ...
        '電路設計': [EE_ELECTRO_CIRCUIT_DESIGN_KEY_WORDS, EE_ELECTRO_CIRCUIT_DESIGN_ANTI_KEY_WORDS],
