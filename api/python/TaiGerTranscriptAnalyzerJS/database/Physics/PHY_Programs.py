...
def RWTH_PHYSICS(transcript_sorted_group_map, df_transcript_array, df_category_courses_sugesstion_data, writer):
    program_name = 'RWTH_PHYSICS'
    print("Create " + program_name + " sheet")
    df_transcript_array_temp = []
    df_category_courses_sugesstion_data_temp = []
    for idx, df in enumerate(df_transcript_array):
    ...
    PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Experimental physics', 'Required_ECTS': 17}
    PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Theoretical physics', 'Required_ECTS': 16}
    PROG_SPEC_ADVANCED_LAB_COURSE_METHODE_PARAM = {
        'Program_Category': 'Advanced Lab Courses', 'Required_ECTS': 9}
    PROG_SPEC_OTHERS = {
        'Program_Category': 'Others', 'Required_ECTS': 0}
    ...
    program_category_map = [
        ...
        PROG_SPEC_OTHERS,  # 數學
        PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM,  # 普通物理
        PROG_SPEC_ADVANCED_LAB_COURSE_METHODE_PARAM,  # 物理實驗
        PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM,  # 力學
        PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM,  # 進階物理
        PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM,  # 分子物理
        PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM,  # 量子物理
        PROG_SPEC_ADVANCED_LAB_COURSE_METHODE_PARAM,  # 凝態物理
        PROG_SPEC_ADVANCED_LAB_COURSE_METHODE_PARAM,  # 核物理
        PROG_SPEC_ADVANCED_LAB_COURSE_METHODE_PARAM,  # 天文物理
        PROG_SPEC_OTHERS,  # 普通化學
        PROG_SPEC_OTHERS,  # 有機化學
        PROG_SPEC_OTHERS,  # 進階化學
        PROG_SPEC_OTHERS,  # 無機化學
        ...
        PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM,  # 電磁學
        PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM,  # 熱力學
        PROG_SPEC_ADVANCED_LAB_COURSE_METHODE_PARAM,  # 論文
        PROG_SPEC_OTHERS  # 其他
    ]
...
def UNI_WURZBURG_PHYSICS(transcript_sorted_group_map, df_transcript_array, df_category_courses_sugesstion_data, writer):
    program_name = 'UNI_WURZBURG_PHYSICS'
    print("Create " + program_name + " sheet")
    df_transcript_array_temp = []
    df_category_courses_sugesstion_data_temp = []
    for idx, df in enumerate(df_transcript_array):
    ...
    PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Mechanics, electromagnetism, optics, thermodynamics, atomic und molecular physics, solid state physics, nuclear and elementary particle physics,', 'Required_ECTS': 24}
    PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Theoretical mechanics, quantum mechanics, theoretical electrodynamics, statistical mechanics, thermodynamics', 'Required_ECTS': 22}
    PROG_SPEC_MATH_METHODE_PARAM = {
        'Program_Category': 'Analysis, linear algebra, differential equations, complex analysis', 'Required_ECTS': 22}
    PROG_SPEC_ADVANCED_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Advanced physics: Nuclear, astrophysics condensed matter', 'Required_ECTS': 30}
    PROG_SPEC_THESIS_PARAM = {
        'Program_Category': 'An interdisciplinary thesis on a topic in which physics methods are essentially applied', 'Required_ECTS': 10}
    PROG_SPEC_OTHERS = {
        'Program_Category': 'Others', 'Required_ECTS': 0}
...
def UNI_FREIBURG_APPLIED_PHYSICS(transcript_sorted_group_map, df_transcript_array, df_category_courses_sugesstion_data, writer):
    program_name = 'UNI_FREIBURG_APPLIED_PHYSICS'
    print("Create " + program_name + " sheet")
    df_transcript_array_temp = []
    df_category_courses_sugesstion_data_temp = []
    for idx, df in enumerate(df_transcript_array):
    ...
    # Create transcript_sorted_group to program_category mapping
    PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Theoretical physics (mechanics, electromagnetism, quantum mechanics, thermodynamics/statistical physics)', 'Required_ECTS': 32}
    PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Experimental physics (mechanics, thermodynamics, electromagnetism, optics, structure of matter)', 'Required_ECTS': 32}
    PROG_SPEC_MATH_METHODE_PARAM = {
        'Program_Category': 'Mathematics (analysis, linear algebra)', 'Required_ECTS': 24}
    PROG_SPEC_LABOR_PRAKTIKA_METHODE_PARAM = {
        'Program_Category': 'Physics lab courses (beginners, advanced lab)', 'Required_ECTS': 18}
    PROG_SPEC_BACHELOR_THESIS_METHODE_PARAM = {
        'Program_Category': 'Bachelor Thesis', 'Required_ECTS': 10}
    PROG_SPEC_OTHERS = {
        'Program_Category': 'Others', 'Required_ECTS': 0}
    ...
    program_category_map = [
        ...
        PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM,  # 分子物理
        PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM,  # 量子物理
        PROG_SPEC_OTHERS,  # 凝態物理
        PROG_SPEC_OTHERS,  # 核物理
        PROG_SPEC_OTHERS,  # 天文物理
        PROG_SPEC_OTHERS,  # 普通化學
        PROG_SPEC_OTHERS,  # 有機化學
        PROG_SPEC_OTHERS,  # 進階化學
...
def KIT_PHYSICS(transcript_sorted_group_map, df_transcript_array, df_category_courses_sugesstion_data, writer):
    program_name = 'KIT_PHYSICS'
    print("Create " + program_name + " sheet")
    df_transcript_array_temp = []
    df_category_courses_sugesstion_data_temp = []
    for idx, df in enumerate(df_transcript_array):
    ...
    # Create transcript_sorted_group to program_category mapping
    PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Theoretical physics (mechanics, electrodynamics, quantum mechanics, statistical physics)', 'Required_ECTS': 32}
    PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM = {
        'Program_Category': 'Experimental physics (mechanics, electrodynamics, optics, thermodynamics, atomic, molecular and nuclear physics, structure of matter)', 'Required_ECTS': 32}
    PROG_SPEC_LABOR_PRAKTIKA_METHODE_PARAM = {
        'Program_Category': 'Physics lab courses (beginners, advanced lab)', 'Required_ECTS': 18}
    PROG_SPEC_OTHERS = {
        'Program_Category': 'Others', 'Required_ECTS': 0}
    ...
    program_category_map = [
        ...
        PROG_SPEC_THEORETICAL_PHYSICS_METHODE_PARAM,  # 量子物理
        PROG_SPEC_OTHERS,  # 凝態物理
        PROG_SPEC_EXPERIMENT_PHYSICS_METHODE_PARAM,  # 核物理
        PROG_SPEC_OTHERS,  # 天文物理
        PROG_SPEC_OTHERS,  # 普通化學
        PROG_SPEC_OTHERS,  # 有機化學
        PROG_SPEC_OTHERS,  # 進階化學
...
program_sort_function = [TUM_LMU_QUANTUM_SCIENCE_TECH,
                         TUM_PHYSICS_NUCLEAR, RWTH_PHYSICS, UNI_WURZBURG_PHYSICS, UNI_FREIBURG_APPLIED_PHYSICS, KIT_PHYSICS]
