...
def PSY_sorter(program_idx, file_path, abbrev, studentId, student_name, analysis_language):
    ...
    basic_classification_zh = {
        ...
        '觀察研究': [EP_RESEARCH_KEY_WORDS, EP_RESEARCH_ANTI_KEY_WORDS, ['一', '二']],
        '程式': [PROGRAMMING_LANGUAGE_KEY_WORDS, PROGRAMMING_LANGUAGE_ANTI_KEY_WORDS, ['一', '二']],
        '資料科學': [DATA_SCIENCE_KEY_WORDS, DATA_SCIENCE_ANTI_KEY_WORDS],
        '論文': [BACHELOR_THESIS_KEY_WORDS, BACHELOR_THESIS_ANTI_KEY_WORDS, ['一', '二']],
