...
ELECTRO_CIRCUIT_KEY_WORDS = ['電路', '訊號', '數位邏輯', '邏輯設計', '信號與系統', '訊號與系統']
ELECTRO_CIRCUIT_ANTI_KEY_WORDS = ['超大型', '專題', '倫理', '素養', '進階']
ELECTRO_MAGNET_KEY_WORDS = ['電磁']
ELECTRO_MAGNET_ANTI_KEY_WORDS = ['asdgladfj;l', '專題', '進階']
POWER_ELECTRO_KEY_WORDS = ['電力', '能源', '電動機', '電機', '高壓電', '電傳輸']
POWER_ELECTRO_ANTI_KEY_WORDS = ['asdgladfj;l', '專題', '進階']
COMMUNICATION_KEY_WORDS = ['高頻', '天線', '微波',
...
MACHINE_RELATED_KEY_WORDS = ['力學', '流體',
                             '熱力', '傳導', '熱傳', '機械', '動力', '熱流', '機動']
MACHINE_RELATED_ANTI_KEY_WORDS = ['asdgladfj;l']
