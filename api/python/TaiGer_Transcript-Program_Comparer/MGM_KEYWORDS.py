...
ME_MASCHINENGESTALTUNG_KEY_WORDS = ['繪圖', '電腦輔助', '機械設計', '機構', '機械構', '機械','工程圖']
...
ME_WERKSTOFFKUNDE_ANTI_KEY_WORDS = ['asdgladfj;l','力學']
...
ME_MECHANIK_KEY_WORDS = ['力學', '動力', '機動', '振動', '震動', '運動學']
ME_MECHANIK_ANTI_KEY_WORDS = ['熱力', '流體', '車輛', '氣動']
ME_ELECTRICAL_ENG_KEY_WORDS = ['電力電子', '電機', '電動機', '電磁', '電驅動', '電子']
...
ME_VEHICLE_KEY_WORDS = ['車輛','煞車','內燃機','電驅動']
