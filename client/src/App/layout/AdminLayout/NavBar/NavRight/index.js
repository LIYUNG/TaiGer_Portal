        ...
        return (
            <Aux>
                <ul className="navbar-nav ml-auto">
                    ...
                    <li><a href={DEMO.BLANK_LINK} className={this.props.rtlLayout ? 'm-r-15' : 'm-l-15'}><i className="feather icon-settings" />  Settings</a></li>
                    ...
                    <li className={this.props.rtlLayout ? 'm-r-15' : 'm-l-15'}>
                        <a href={DEMO.BLANK_LINK} className="displayChatbox" onClick={() => { this.setState({ listOpen: true }); }}><i className="icon feather icon-mail" /> Messages</a>
                    </li>
                    <li>
                        {/* <a href={DEMO.LOG_OUT} className="dud-logout" title="Logout">
                        <i className="feather icon-log-out" /> Logout</a> */}
                        <Link to={'/'} onClick={this.handleOnClick} className="dud-logout">Logout</Link>
                    </li>
                    {/* <li><a href={DEMO.BLANK_LINK} className="dropdown-item"><i className="feather icon-settings"/> Settings</a></li> */}
                </ul>
