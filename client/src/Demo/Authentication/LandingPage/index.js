          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Typography>
                  We offer a range of services to help you succeed, from
                  application assistance to visa support.
                </Typography>
              </Paper>
            </Grid>
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Typography>
                  Hear from our successful students who have achieved their
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                <Typography>
                  Have questions? Get in touch with us and we will be happy to
                  assist you.
                </Typography>
              </Paper>
            </Grid>
