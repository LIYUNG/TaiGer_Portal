...
//   const [editor_list, setEditor_list] = useState([]);
//   const [isLoaded, setIsLoaded] = useState(false);
//   const [students, setStudents] = useState([]);
//   const [updateAgentList, setUpdateAgentList] = useState({});
//   const [updateEditorList, setUpdateEditorList] = useState({});
...
//   const onDownloadFilefromstudent = (e, category, id) => {
//     e.preventDefault();
//     download(category, id).then(
//       (resp) => {
//         const actualFileName =
...
//   const onRejectFilefromstudent = (e, category, applicationId, studentId) => {
//     //id == student id
//     e.preventDefault();
//     rejectDocument(category, applicationId, studentId).then(
//       (result) => {},
...
//   const onAcceptFilefromstudent = (e, category, applicationId, studentId) => {
//     //id == student id
//     e.preventDefault();
//     acceptDocument(category, applicationId, studentId).then(
//       (result) => {},
...
//     );
//   };
//   const onDeleteProgram = (e, student_id, program_id) => {
//     //program id
//     e.preventDefault();
//     removeProgramFromStudent(program_id, student_id).then(
//       (result) => {},
...
//   const onDeleteFilefromstudent = (e, category, id) => {
//     e.preventDefault();
//     deleteFile(category, id).then(
//       (resp) => {},
//       (error) => {}
...
//   const submitUpdateAgentlist = (updateAgentList, student_id) => {
//     console.log(updateAgentList + " " + student_id);
//     this.UpdateAgentlist(updateAgentList, student_id);
//   };

//   const submitUpdateEditorlist = (updateEditorList, student_id) => {
//     console.log(updateEditorList + " " + student_id);
//     this.UpdateEditorlist(updateEditorList, student_id);
//   };

//   const UpdateAgentlist = (updateAgentList, student_id) => {
//     updateAgents(student_id, updateAgentList).then(
//       (resp) => {
//         this.setState({
//           updateAgentList: [],
...
//   const UpdateEditorlist = (updateEditorList, student_id) => {
//     updateEditors(student_id, updateEditorList).then(
//       (resp) => {
//         this.setState({
//           updateEditorList: [],
