    ...
    <>
      <Card sx={{ p: 2 }}>
        <Box>
          ...
          <ProgramDistributionChart data={data?.countryCount} x_key="country" />
          By School:
          <ProgramDistributionChart data={data?.schoolCount} x_key="school" />
          By Language:
          <ProgramDistributionChart data={data?.langCount} x_key="lang" />
          By Degree:
          <ProgramDistributionChart data={data?.degreeCount} x_key="degree" />
          By Last Update:
