...
# TODO
def TUM_CHEMICAL_BIOTECH(transcript_sorted_group_map, df_transcript_array, df_category_courses_sugesstion_data, writer):
    program_name = 'TUM_CHEMICAL_BIOTECH'
...
program_sort_function = [TUM_CHEMICAL_BIOTECH]
