...
def CVE_sorter(program_idx, file_path, abbrev, studentId, student_name, analysis_language):
    ...
    basic_classification_en = {
            ...
            '控制系統': [CONTROL_THEORY_KEY_WORDS_EN, CONTROL_THEORY_ANTI_KEY_WORDS_EN, ['一', '二']],
            ...
            '基礎電機電子': [ELECTRICAL_ENG_KEY_WORDS_EN, ELECTRICAL_ENG_ANTI_KEY_WORDS_EN],
            ...
            '測量': [MEASUREMENT_KEY_WORDS_EN, MEASUREMENT_ANTI_KEY_WORDS_EN],
            '車輛': [VEHICLE_ENGINEERING_KEY_WORDS_EN, VEHICLE_ENGINEERING_ANTI_KEY_WORDS_EN],
    ...
    basic_classification_zh = {
            ...
            '控制系統': [CONTROL_THEORY_KEY_WORDS, CONTROL_THEORY_ANTI_KEY_WORDS, ['一', '二']],
            ...
            '基礎電機電子': [ELECTRICAL_ENG_KEY_WORDS, ELECTRICAL_ENG_ANTI_KEY_WORDS],
            ...
            '測量': [MEASUREMENT_KEY_WORDS, MEASUREMENT_ANTI_KEY_WORDS],
            '車輛': [VEHICLE_ENGINEERING_KEY_WORDS, VEHICLE_ENGINEERING_ANTI_KEY_WORDS],
